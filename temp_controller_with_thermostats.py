...
# Function in charge of sending telemetry to IoT Central.
    # Calling class "pnp_helper". Function "create_telemetry" will create a JSON file with the telemetry.
    # "send_message": Sends a message to the default events endpoint on the Azure IoT Hub inside IoT Central.
    # https://docs.microsoft.com/en-us/python/api/azure-iot-device/azure.iot.device.aio.iothubdeviceclient?view=azure-python#azure-iot-device-aio-iothubdeviceclient-send-message
...
# Function that handles writable property updates and generates the JSON response.
...
async def main():
    ...
    if switch == "DPS":
        ...
        # Establish connection to IoT Central using function class "IoTHubDeviceClient" and function "create_from_symmetric_key".
            #https://docs.microsoft.com/en-us/python/api/azure-iot-device/azure.iot.device.aio.iothubdeviceclient?view=azure-python#azure-iot-device-aio-iothubdeviceclient-create-from-symmetric-key
    ...
    # Establish connection to IoT Central using function class "IoTHubDeviceClient" and function "create_from_connection_string".
        # https://docs.microsoft.com/en-us/python/api/azure-iot-device/azure.iot.device.aio.iothubdeviceclient?view=azure-python#azure-iot-device-aio-iothubdeviceclient-create-from-connection-string
    ...
    # Update readable properties from various components
        # Calling Class "pnp_helper" from file "pnp_helper.py"
